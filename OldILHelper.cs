...
namespace AeroCore
{
    public class OldILHelper
    {
        ...
        public OldILHelper(string Name, IMonitor Monitor)
        {
            name = Name;
        ...
        public OldILHelper Skip(IList<CodeInstruction> codes)
        {
        ...
        /// <returns>This</returns>
        public OldILHelper RemoveTo(IList<CodeInstruction> codes)
        {
        ...
        /// <returns>This</returns>
        public OldILHelper RemoveTo(CodeInstruction code) => RemoveTo(new[] { code });

        /// <summary>Delete a number of instructions</summary>
        /// <param name="Count">How many to delete</param>
        /// <returns>This</returns>
        public OldILHelper Remove(int Count)
        {
        ...
        /// <returns>This</returns>
        public OldILHelper Transform(IList<CodeInstruction> codes, Transformer transformer)
        {
        ...
        /// <returns>This</returns>
        public OldILHelper Transform(CodeInstruction code, Transformer transformer) => Transform(new[] { code }, transformer);

        /// <summary>Add instructions</summary>
        /// <param name="codes">The instructions to add</param>
        /// <returns>This</returns>
        public OldILHelper Add(IList<CodeInstruction> codes)
        {
        ...
        /// <returns>This</returns>
        public OldILHelper Add(CodeInstruction code) => Add(new[] { code });

        /// <summary>Output the rest of the instructions as-is</summary>
        /// <returns>This</returns>
        public OldILHelper Finish()
        {
        ...
        /// <returns>This</returns>
        public OldILHelper Collect(IList<CodeInstruction> codes)
        {
